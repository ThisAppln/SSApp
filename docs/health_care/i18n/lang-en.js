window.langEN = {
  hero_text: 'Better care,',
  hero_span: 'better outcomes',
  learnmore: 'Learn more',
  contactus: 'Contact us',
  searchproviders: 'Search providers',
  scheduleappointment: 'Schedule an appointment',
  seeoptions: 'See options',
  secondary1_title: 'U+Health System medicine news',
  secondary1_msg: 'New, noninvasive treatment for movement disorders.',
  secondary2_title: 'Patient stories',
  secondary2_msg: 'Every patient has a story to share.  Read inspiring stories of U+ Health System patients and learn about life-changing surgeries, innovative procedures and other ways we’re saving and improving lives.',
  primary1_title: 'Find a provider',
  primary1_msg: 'Find a doctor tool assists you in choosing from a diverse pool of health specialist.',
  primary2_title: 'Make an appointment',
  primary2_msg: 'Whether you are a new or existing patient, we are here to help you schedule an appointment.',
  primary3_title: 'Services',
  primary3_msg: 'When you need care, explorer our services amd locations to meet your needs.',
  menu1: 'MyHealthChart',
  menu2: 'Make an appointment',
  menu3: 'Patients & Visitors',
  menu4: 'Refer a patient',
  login: 'Log in',
  logout: 'Log out',
  ...
  accountoverview: 'My Medical Chart',
